...
package validatorregistryv1_aug15
...
type IValidatorRegistryV1StakedValidator struct {
	...
	Balance           *big.Int
	UnstakeHeight     EventHeightLibEventHeight
}
...
//
// Solidity: function stakedValidators(bytes ) view returns(bool exists, address withdrawalAddress, uint256 balance, (bool,uint256) unstakeHeight)
func (_Validatorregistryv1 *Validatorregistryv1Caller) StakedValidators(opts *bind.CallOpts, arg0 []byte) (struct {
	...
	outstruct.UnstakeHeight = *abi.ConvertType(out[3], new(EventHeightLibEventHeight)).(*EventHeightLibEventHeight)
